...
class TelegramSendReminder extends Notification
{
    ...
    {
      $textMessage = "https://api.whatsapp.com/send/?phone=7$this->phone&text=Здравствуйте,+$this->name!\nНапоминаю,+Вы+записаны+на:+Маникюр,+$this->time.+Адрес:+г.Иркутск,+ул.+Советская+109,+офис+314.+(Вход+в+белую+дверь,+над+дверью+вывеска+-+Иркутский+Дом+Печати).+\nВаш+мастер:+Белоусова+Кристина.";
      $textMessage = $this->my_url_encode($textMessage);
        return TelegramMessage::create()
            ->button($this->name, $textMessage)
