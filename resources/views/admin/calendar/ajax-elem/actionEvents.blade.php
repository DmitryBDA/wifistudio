...
@if(isset($event))
  <div class="modal-footer justify-content-between">
    ...
    <div style="width: 100%;"><label for="">Имя:
        <span>@if($event->user){{$event->user->name}} {{$event->user->surname}} @endif</span></label>
    </div>
      ...
      <div>
        <div class="row">
          <div class="form-group">
            <input id="add_surname" type="text" class="form-control" name="surname" placeholder="Фамилия"
                   autocomplete="off" required>
          </div>
          <div class="form-group">
            <input id="add_name" type="text" class="form-control" name="name" placeholder="Имя" autocomplete="off"
                   required>
          </div>
          <div class="form-group">
